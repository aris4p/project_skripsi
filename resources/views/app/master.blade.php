...
<head>
    ...
    <title>{{ Auth::user()->level }} - {{ config('app.name', 'CV. Mitra Warnatama') }}</title>
...
<body>
            ...
            <div class="brand-logo">
                <a href="{{ url('/home') }}">
                    ...
                    <span class="brand-title">
                        ...
                        <span class="text-white ml-2">SI<b>KEU</b></span>
                    </span>
                </a>
            </div>
        </div>
    ...
    <div class="nk-sidebar">           
            ...
            <div class="media align-items-center mb-1 mt-3">
               ...
               @endif
                <div class="media-body">
                    ...
                    <p class="text-muted mb-0"><?php if(Auth::user()->level == "admin"){ echo "Administrator";}
                                    elseif(Auth::user()->level == "pimpinan"){ echo "Pimpinan"; }
                                    else { echo "Bendahara"; }?></p>
                </div>
            </div>
        </div>
        ...
        <div class="nk-nav-scroll">
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="{{ route('akun') }}" aria-expanded="false">
                        <i class="icon-grid menu-icon mr-3"></i><span class="nav-text">Data Akun</span>
                    </a>
                </li>
                @if(Auth::user()->level == "admin" || Auth::user()->level == "bendahara" )
                <li class="mega-menu mega-menu-sm">
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        <i class="icon-notebook menu-icon mr-3"></i><span class="nav-text">Data </span>
                    </a>
                ...
                @if(Auth::user()->level == "admin" || Auth::user()->level == "bendahara" )
                <li>
                    <a href="{{ route('jurnal') }}" aria-expanded="false">
                        <i class="icon-menu menu-icon mr-3"></i><span class="nav-text">Jurnal</span>
                    </a>
                </li>
                @endif  
                ...
                <li class="mega-menu mega-menu-sm">
                <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        <i class="icon-menu menu-icon mr-3"></i><span class="nav-text">Laporan</span>
                    </a>    
                    <ul aria-expanded="false">
                    <li><a href="{{ route('rekapdata') }}">Data Penjualan & Pembelian </a></li>
                    <li><a href="{{ route('jurnalumum') }}">Jurnal Umum </a></li>
                    <li><a href="{{ route('bukubesar') }}">Buku Besar </a></li>
                    <li><a href="{{ route('neracasaldo') }}">Neraca Saldo </a></li>
                    </ul>
    ...
    <div class="footer">
        <div class="copyright">
            <p>Copyright &copy; Aplikasi Keuangan {{ date('Y') }} by Aris</p>
        </div>
    </div>
</div>
