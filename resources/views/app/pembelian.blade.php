  ...
  <div class="container-fluid">
    ...
    <div class="card">
      ...
      <div class="card-header pt-4">
        ...
        <a href="{{ route('pembelian.tambah') }}" class="btn btn-primary float-right"><i class="fa fa-plus"></i> &nbsp TAMBAH pembelian</a>
        @endif
          ...
          <table class="table table-bordered" id="table-datatable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">{{ $p->supplier->nama }}</td>                      
                ...
                <td>    
                  ...
                  <div class="text-center">
                    <a href="{{ route('pembelian.edit', ['id' => $p->id]) }}" class="btn btn-default btn-sm">
                      <i class="fa fa-cog"></i>
                    </a>
                   ...
                   <!-- modal hapus -->
                   <form method="POST" action="{{ route('pembelian.delete',['id' => $p->id]) }}">
